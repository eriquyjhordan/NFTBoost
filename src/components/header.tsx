...
export default function Header() {
  return (
    <header className="absolute top-0 right-0 w-full">
      <div className="container flex items-center justify-between mt-6 lg:mt-5">
        <Link href="/">
          <Image src={nftLogo} alt="nft logo" priority />
        </Link>
        ...
        <button className="p-2 bg-white/[3%] border border-white/5 lg:hidden rounded">
          <Image src={hamburgerMenu} alt="hamburger menu" priority />
        </button>
      </div>
    </header>
  )
